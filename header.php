...
<html lang="fr">
  ...
  <body <?php body_class(); ?>>
    <nav class="navbar <?php echo is_front_page() || is_page('fruits') || is_page('legumes') || is_page('favoris') ? 'home-navbar' : ''; ?>">
      <div class="container-fluid">
        <div class="row align-items-center w-100">
          <div class="col-md-3">
            <div class="logo">
              <?php if (is_front_page() || is_page('fruits') || is_page('legumes') || is_page('favoris')): ?>
            ...
            <?php if (is_front_page() || is_page('fruits') || is_page('legumes') || is_page('favoris')) : ?>
              ...
              <?php else : ?>
                <div class="user-icons d-flex align-items-center justify-content-end gap-4">
                  <a href="<?php echo get_permalink(get_page_by_path('favoris')); ?>" class="icon-link"><i class="fas fa-heart"></i></a>
